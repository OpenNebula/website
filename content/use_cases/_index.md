...
{{< alert title="Note" color="success" >}} Content TBD. There is also a [Use Cases]({{% relref "../7.0/quick_start/understand_opennebula/opennebula_concepts/use_cases" %}}) in the documentation.{{< /alert >}}
