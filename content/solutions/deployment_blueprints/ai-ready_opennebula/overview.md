...
3. Perform Validation:  as a prerequisite, you must have an AI Factory ready to be validated. These are the options to validate your AI Factory:
    ...
    * [Finetune an LLM model using Slurm]({{% relref "solutions/deployment_blueprints/ai-ready_opennebula/finetuning_on_slurm_worker" %}}): finetuning an LLM model using the Slurm appliance.