...
You only need to read this chapter if you are upgrading OpenNebula to a newer release. Make sure you have read the [Release Notes]({{% relref "../../release_information/release_notes" %}}) and particularly the [Compatibility]({{% relref "../../release_information/release_notes/compatibility#compatibility" %}}) section first.
