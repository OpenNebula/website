...
- Option to define [Compute Quotas per Cluster](../../../product/cloud_system_administration/capacity_planning/quotas#compute-quotas) to achieve more granular control of resources.
