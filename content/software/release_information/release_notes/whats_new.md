...
* [VLAN Rules]({{% relref "manage_vnets#group-vlan-rules" %}}) enable cloud administrators fo delegate VLAN management to tenants in multi-tenant clouds, allowing tenant self-provisioning of Virtual Networks.
