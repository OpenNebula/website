...
{{< image
  pathDark="images/sunstone/common/dark/sunstone_showcase_dashboard.png"
  path="images/sunstone/common/light/sunstone_showcase_dashboard.png"
...
* Fix PCI device and PCI NIC quota accounting when instantiating VMs from templates [#7922](https://github.com/OpenNebula/one/issues/7922).
