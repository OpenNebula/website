...
* VLAN_ID is not mandatory when creating a OpenvSwitch in Sunstone. See [Open vSwitch Networks](../../../product/cluster_configuration/networking_system/openvswitch/) for details.
