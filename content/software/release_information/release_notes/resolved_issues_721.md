...
* VLAN_ID is not mandatory when creating a Open vSwitch in Sunstone. See [Open vSwitch Networks]({{% relref "product/cluster_configuration/networking_system/openvswitch/" %}}) for details.
...
* Fix fireedge.error added into logrotate [#7621](https://github.com/OpenNebula/one/issues/7621).
...
* Fix NIC not gonna be attached to template even specified in yaml file (OneSwap) [#7526](https://github.com/OpenNebula/one/issues/7526).
* Fix Cluster name contains space in name (oneswap) [#7525](https://github.com/OpenNebula/one/issues/7525).
