...
For more information on configuring the information and monitoring system and hints to extend it, please check the [monitoring configuration]({{% relref "monitoring#mon-conf" %}}) and [information driver configuration guide]({{% relref "../../../integration_and_development/integration_references/infrastructure_drivers_development/devel-im#devel-im" %}}).
