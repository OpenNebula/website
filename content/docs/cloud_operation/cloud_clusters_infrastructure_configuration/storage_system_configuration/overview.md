...
Before reading this chapter make sure you are familiar with Node Deployment from [Open Cloud Deployment]({{% relref "../../package_installation_references/index#vmmg" %}}).
