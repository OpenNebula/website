...
- **CEPH** + **SSH** described in [Ceph SSH mode]({{% relref "../../../cloud_operation/cloud_clusters_infrastructure_configuration/storage_system_configuration/ceph_ds#ceph-ssh-mode" %}})
