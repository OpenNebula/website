...
{{< image path="/images/datastoreoverview.svg" alt="Overview of Storage Design based on Datastores" align="center" width="60%" mb="20px" >}}
...
| --                                                            | --                                                                                                     | --     | --                             | --             | --           | --                | --              | --      | --           |
| [Local storage]({{% relref "local_ds" %}})                    | Images stored in frontend* and transferred to hosts via<br/>SSH on instantiation.                      | no     | raw/qcow2                      | yes            | yes          | poweroff/live     | yes             | KVM/LXC | EE/CE        |
| [NFS/NAS]({{% relref "nas_ds" %}})                            | Images stored in a NFS share, activated directly.                                                      | yes    | raw/qcow2                      | yes            | yes          | poweroff/live     | no              | KVM/LXC | EE/CE        |
