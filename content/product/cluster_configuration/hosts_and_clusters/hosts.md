...
2. **File cache** — consults `/var/lib/one-remotes-db/pci_net_names/<PCI_ADDRESS>`, where each file (named as the PCI address) contains the interface name. Created automatically on first resolution.
