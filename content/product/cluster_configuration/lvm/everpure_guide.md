---
title: "SAN/LVM: Everpure setup"
linkTitle: "Everpure: SAN setup"
weight: "2"
---

This setup assumes you are using a Everpure FlashArray with iSCSI and want to use it as a backend for one of OpenNebula's [LVM datastore options]({{% relref "." %}}). The configuration uses standard volume and Host mappings. If you are familiar with the Everpure interface, create the required resources as desired.
