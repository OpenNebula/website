...
| `ETHx_ROUTES`                   | Comma-separated list of custom routes for the interface. Format: <dst_network1> via <gateway1>, <dst_network2> via <gateway2>. This attribute is automatically filled if the virtual network (vNet) or the selected AR contains the `ROUTES` attribute, using the routes defined there.                                                                                                                                                                                                                            | O         |
