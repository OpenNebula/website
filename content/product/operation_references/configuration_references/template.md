...
| `NETWORK`                       | `YES` to fill automatically the networking parameters for each NIC, used by the [Contextualization packages]({{% relref "../../virtual_machines_operation/virtual_machine_images/vm_templates#context-overview" %}}).                                                                                                                                                                                                                                                                                              | O         |
