...
These elements are combined through an JSON document stored in the OpenNebula database like in the following example:
...
For more information about how to create or modify an existing Driver, refer to the [Provisioning Drivers  guide](/product/integration_references/cloud_provider_driver_development/).
