...
| `template_id`         | integer           | **YES**                         | OpenNebula VM Template ID. See the [OpenNebula documentation for VM Templates]({{% relref "../../../product/virtual_machines_operation/virtual_machines/vm_templates#vm-guide" %}}).                                |
