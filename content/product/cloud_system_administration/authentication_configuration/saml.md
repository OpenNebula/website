...
The `saml` authentication driver can be configured in [/etc/one/auth/saml_auth.conf](https://github.com/OpenNebula/one/blob/master/src/authm_mad/remotes/saml/saml_auth.conf).
