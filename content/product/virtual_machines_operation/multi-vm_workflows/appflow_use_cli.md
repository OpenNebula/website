...
{{< image path="/images/service_sample.svg" alt="Multi-tier application with deployment dependencies" align="center" width="60%" mb="20px" >}}
...
{{< image path="/images/oneflow-network-map.svg" alt="OneFlow Network Mapping" align="center" width="60%" mb="20px" >}}
