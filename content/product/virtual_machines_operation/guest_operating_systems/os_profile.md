...
| →→ NETWORK_MASK                   | string  | Network mask in dot notation ("255.0.0.0").  | Valid subnet mask                 |
...
| →→ PIN_POLICY    | string | NUMA pinning policy        | “NONE”, “THREAD”,<br/>“SHARED”, “CORE”,<br/>“NODE_AFFINITY” |
