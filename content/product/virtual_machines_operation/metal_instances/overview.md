...
This section provides guides for deploying and operating Bare Metal as a Service and related metal workload services with OpenNebula. The initial guide covers integration with the NVIDIA Infra Controller (NICo), enabling automated bare-metal lifecycle management for accelerated infrastructure, including systems built around NVIDIA networking, GPUs, and DPUs.
