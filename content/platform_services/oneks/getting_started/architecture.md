...
{{< image path="/images/oneks_service_architecture.png" alt="OneKS Service Architecture" align="center" width="80%" mb="20px" >}}
...
{{< image path="/images/oneks_deployed_architecture.png" alt="OneKS Deployed Architecture" align="center" width="80%" mb="20px" >}}
...
{{< image path="/images/oneks_domain_architecture.png" alt="OneKS Domain Architecture" align="center" width="80%" mb="20px" >}}
