...
{{< image path="/images/6_features.svg" alt="OpenNebula Hypervisors" align="center" width="80%" pb="20px" >}}
...
{{< image path="/images/new_overview_integrators.svg" alt="OpenNebula Cloud Architecture" align="center" width="80%" pb="20px" >}}
