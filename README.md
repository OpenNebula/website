...
Hugo should build the site and expose it on `localhost:1313/7.2/`.
...
To view the site, fire up a browser and go to `localhost:1313/7.2/`. You should see the home page of the OpenNebula docs site, with the table of  contents on the left.
...
- `version`: The short version of OpenNebula, e.g. `7.2`.
- `release`: The full release version of OpenNebula, e.g. `6.99.85`.
- `context_release`: Version of the context packages, e.g. `7.2.0`.
- `docs_version`: Version of the documentation, e.g. `7.2`.
